...
class SwapRequestViewSet(viewsets.ModelViewSet):
    queryset = SwapRequest.objects.select_related('requester__user', 'recipient__user', 'talent_listing').all()
    ...
    def confirm_delivery(self, request, pk=None):
        ...
        return Response({
            ...
            "message": "Both parties confirmed! Escrow funds released." if completed else "Delivery recorded. Awaiting peer confirmation."
        })
    ...
    def release_escrow(self, request, pk=None):
        ...
        swap.save()
        return Response({"status": "success", "message": "Escrow released back to participants."})
...
class NowPaymentsInvoiceView(APIView):
    ...
    def post(self, request):
        ...
        return Response(NowPaymentTransactionSerializer(tx).data, status=status.HTTP_201_CREATED)
