...
export const MySwapsView: React.FC<MySwapsViewProps> = ({
  ...
  return (
    <div className="space-y-8">
      {/* Header and Filter */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-4 border-b border-[#F2EBE0]">
        <div>
        ...
        <div className="p-12 text-center bg-white rounded-3xl border border-[#EAE3D6] shadow-[0_4px_20px_-4px_rgba(44,37,35,0.05)] space-y-3">
          ...
          <div className="pt-2">
            <button
              ...
              className="px-6 py-2.5 rounded-full text-xs font-semibold text-white bg-[#D95338] hover:bg-[#C84634] active:scale-[0.98] transition-all duration-300 ease-out cursor-pointer shadow-sm shadow-[#D95338]/20"
            >
              Teach a Skill
            </button>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-[#F2EBE0]">
                  <div className="flex items-center gap-3">
                    <img
                      src={peer.avatar}
                      alt={peer.name}
                      className="w-11 h-11 rounded-full object-cover ring-2 ring-[#EAE3D6]"
                    />
                    <div>
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="text-xs text-[#8C827A]">• {peer.location}</span>
                      </div>
                      <p className="text-xs text-[#6E645F] mt-0.5">
                  ...
                  <div className="flex items-center gap-2">
                    {swap.status === 'completed' ? (
                      ...
                      <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#2D2623] text-white flex items-center gap-1.5">
                      ...
                      <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#FDF2EE] text-[#D95338] border border-[#FAD5C8] flex items-center gap-1.5">
                    ...
                    <div className="p-4 rounded-2xl bg-[#FAF7F2] border border-[#EAE3D6] space-y-1">
                      <div className="flex items-center justify-between">
                        ...
                        {swap.status === 'completed' ? (
                          ...
                          <span className="text-[10px] text-[#D95338] font-semibold flex items-center">
                            Protected in Escrow
                            <HelpTooltip text={FINANCE_EXPLANATIONS.escrow} />
                          </span>
                        ) : (
                ...
                <div className="pt-2 flex flex-wrap items-center justify-between gap-3">
                  <div className="text-xs text-[#6E645F] flex items-center gap-1.5">
                    <ShieldCheck className="w-3.5 h-3.5 text-[#D95338]" />
                    <span>
                      {swap.status === 'completed'
                      ...
                      isHire ? (
                        isRequester ? (
                          <button
                            ...
                            className="px-5 py-2.5 rounded-full text-xs font-semibold text-white bg-[#D95338] hover:bg-[#C84634] active:scale-[0.98] transition-all duration-300 ease-out flex items-center gap-1.5 cursor-pointer shadow-sm shadow-[#D95338]/20"
                          >
